...
public class SimpleSectionedRVAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    /** sectionResourceId layoutId, textResourceId TextViewId to set the text*/
